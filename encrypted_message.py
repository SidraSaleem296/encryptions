...
#decryption import base64 import time Charachters = 'ABCDEFGHIJKLMNOPQRSTUVWXYZABCDEFGHIJKLMNOPQRSTUVWXYZ' Charachters = Charachters.lower() List_of_agents = ['Behemoth_arooj','Skipper_sana','Ghoul_hamde','Cryptonic_sid' ,'Drake_zeean ','Gloom_tanzeela','Diablo_areeba']
